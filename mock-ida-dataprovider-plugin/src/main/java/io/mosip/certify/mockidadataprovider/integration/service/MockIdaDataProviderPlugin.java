...
public class MockIdaDataProviderPlugin implements DataProviderPlugin {
    ...
    public JSONObject fetchData(Map<String, Object> identityDetails) throws DataProviderExchangeException {
        try {
            OIDCTransaction transaction = mockTransactionHelper
                    .getUserInfoTransaction(identityDetails.get(ACCESS_TOKEN_HASH).toString());
            ...
            if (individualId != null) {
                ...
                try {
                    log.info("Response data map: " + res);
                } catch (Exception e) {
                ...
                // Add required fields to JSON response
    ...
    public Map<String, Object> fetchData2(Map<String, Object> identityDetails) throws DataProviderExchangeException {
        try {
            OIDCTransaction transaction = mockTransactionHelper
                    .getUserInfoTransaction(identityDetails.get(ACCESS_TOKEN_HASH).toString());
            String individualId = getIndividualId(transaction);
    ...
    protected String getIndividualId(OIDCTransaction transaction) {
        if (!storeIndividualId)
            return null;
        return isIndividualIDEncrypted ? decryptIndividualId(transaction.getIndividualId())
                : transaction.getIndividualId();
    }
